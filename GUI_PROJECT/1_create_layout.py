...
btn_add_file = Button(file_frame, text='파일 추가', padx=5, pady=5, width=12, relief='groove')
btn_add_file.pack(side='left')

btn_del_file = Button(file_frame, text='선택 삭제', padx=5, pady=5, width=12, relief='groove')
...
btn_dest_path = Button(path_frame, text='찾아보기', width=10, relief='groove')
